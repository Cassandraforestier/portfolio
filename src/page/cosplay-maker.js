    ...
    return (
        <div className="cosplaymaker-container">
            ...
            <div className="cosplaymaker-resume">
                <Paragraph>
                    {t('cosplaymaker.description')}
                </Paragraph>
                <Paragraph>
                    {t('cosplaymaker.paragraph-desc')}
                </Paragraph>
                <Paragraph>
                    {t('cosplaymaker.paragraph-desc2')}
                </Paragraph>
                <Button><Link to="https://github.com/Cassandraforestier/cosplay-maker" target='_blank' rel="noreferrer">{t("cosplaymaker.github-link")}</Link></Button>
            </div>
            ...
            <div className="card-container">
                ...
                >
                    ...
                    <div>
                        ...
                        <img src="logo/antdesign.png" alt="Ant Design icon" className="antd-icon" />
                    </div>
                </Card>
                <Card
                    title="Back-end"
                ...
                <Card
                    title={t("cosplaymaker.database-card")}
                ...
                >
                    <img src="logo/reactnative.png" alt="React-native icon" className="react-native-icon" />
                </Card >
            </div >
            ...
            {isMobile ?
                <div className="download-btn">
                    ...
                    >
                        <DownloadOutlined />{t("cosplaymaker.download-powerpoint")}
                    </Button>
                    <Button
                        ...
                        className="pdf-download-link"
                    >
                        <DownloadOutlined />{t("cosplaymaker.download-report")}
                    </Button>
                </div>
                :
                <>
                    <embed src='ppt.pdf' width='60%' height='600' type='application/pdf' className="ppt-display" />
                    <embed src='rapport-cosplay-maker.pdf' width='60%' height='600' type='application/pdf' className="pdf-display" />
                </>
            }
